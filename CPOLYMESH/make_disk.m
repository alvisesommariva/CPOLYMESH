...
function domain=make_disk(center,radius)

%--------------------------------------------------------------------------
% OBJECT:
%--------------------------------------------------------------------------
% In this routine, given the center and the radius of the disk, we define 
% a Matlab variable "domain" of "struct" type that contains the 
% information useful to compute an Admissible Mesh.
%--------------------------------------------------------------------------
% INPUT:
%--------------------------------------------------------------------------
% center: complex number that defines the cartesian coordinates of the 
%         center of the disk;
% radius: positive real number that defines the radius of the disk.
%--------------------------------------------------------------------------
% OUTPUT:
%--------------------------------------------------------------------------
...
if length(center) > 1, center=center(1)+1i*center(2); end

% Main code

domain.intervals=[0 2*pi];
domain.functions=@(t) center+radius*(cos(t)+1i*sin(t));
