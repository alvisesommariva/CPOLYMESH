...
function domain=make_deltoid(a)
...
% Admissible Mesh on the deltoid
%
%                     2*a*exp(i*t)+a*exp(-2*i*t)
%
% with "t" in "[0,2*pi]".
%--------------------------------------------------------------------------
% INPUT:
%--------------------------------------------------------------------------
% a: after setting "a", one defines "b=a/3" and sets this parameters into
%    deltoid definition, i.e.
%                     2*a*exp(i*t)+a*exp(-2*i*t)
%--------------------------------------------------------------------------
% OUTPUT:
%--------------------------------------------------------------------------
...
domain.functions=@(t) 2*a*exp(1i*t)+a*exp(-2*1i*t);
