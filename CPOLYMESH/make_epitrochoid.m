...
function domain=make_epitrochoid(r,R,d)
...
% information useful to compute an Admissible Mesh on the epitrochoid
%
...
% INPUT:
%--------------------------------------------------------------------------
% r,R: parameters defining the epitrochoid, with r < R, R multiple of r.
% d  : parameter defining the epitrochoid defined as
%
%     (R+r)*cos(t)-d*cos((R+r)*t/r)+i*((R+r)*sin(t)-d*sin((R+r)*t/r));
%--------------------------------------------------------------------------
% OUTPUT:
...
domain.functions=@(t) (R+r)*cos(t)-d*cos((R+r)*t/r)+...
    1i*((R+r)*sin(t)-d*sin((R+r)*t/r));
