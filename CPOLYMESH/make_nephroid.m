...
function domain=make_nephroid(a)
...
% Admissible Mesh on the nephroid
%
%          a*(3*cos(t)−cos(3*t)+i*(3*sin(t)−sin(3*t)))
%
% with "t" in "[0,2*pi]".
%--------------------------------------------------------------------------
% INPUT:
...
domain.functions=@(t) a*( 3*cos(t)-cos(3*t) +1i*( 3*sin(t)-sin(3*t) ) );
domain.curve_types='trig';
domain.degrees=3;
domain.name='nephroid';
