...
function domain=make_doubleegg(a)
...
% Admissible Mesh on the double egg
%
%                    (a/2)*( cos(2*t)+1 ).*exp(i*t)
%
% with "t" in "[0,2*pi]".
%--------------------------------------------------------------------------
% INPUT:
%--------------------------------------------------------------------------
% a: parameters defining the double egg
%               (a/2)*( cos(2*t)+1 ).*exp(i*t)
%--------------------------------------------------------------------------
% OUTPUT:
%--------------------------------------------------------------------------
...
% REFERENCE:
%--------------------------------------------------------------------------
% https://mathcurve.com/courbes2d/oeufdouble/oeufdouble.shtml
%--------------------------------------------------------------------------
% AUTHORS:
%--------------------------------------------------------------------------
...
domain.functions=@(t) (a/2)*( cos(2*t)+1 ).*exp(1i*t);
domain.curve_types='trig';
domain.degrees=3;
domain.name='double egg';
