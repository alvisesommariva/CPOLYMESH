...
function domain=make_torpedo(a)
...
% Admissible Mesh on the torpedo
%
%                    a*cos(t).*cos(2*t).*exp(i*t)
%
% with "t" in "[0,2*pi]".
%--------------------------------------------------------------------------
% INPUT:
%--------------------------------------------------------------------------
% a: parameter defining the torpedo curve "a*cos(t).*cos(2*t).*exp(i*t)"
%--------------------------------------------------------------------------
% OUTPUT:
%--------------------------------------------------------------------------
...
% REFERENCE:
%--------------------------------------------------------------------------
% https://mathcurve.com/courbes2d.gb/torpille/torpille.shtml
%--------------------------------------------------------------------------
% AUTHORS:
%--------------------------------------------------------------------------
...
domain.functions=@(t) a*cos(t).*cos(2*t).*exp(1i*t);
