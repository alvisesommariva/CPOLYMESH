...
function domain=make_cardioid(a)
...
% Admissible Mesh on the cardioid
%
%              a*(  (1+cos(n*t)+(sin(n*t))^2).*exp(i*t) )
%
% with "t" in "[0,2*pi]".
%--------------------------------------------------------------------------
% INPUT:
%--------------------------------------------------------------------------
% n: positive integer defining the cardioid
%         a*(  (1+cos(n*t)+(sin(n*t))^2).*exp(i*t) );
%--------------------------------------------------------------------------
% OUTPUT:
%--------------------------------------------------------------------------
...
domain.functions=@(t) a*(cos(t).*(1-cos(t))+1i*(sin(t).*(1-cos(t))));
